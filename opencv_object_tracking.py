...
ap.add_argument('-d'  , '--imagesdirectory' , type=str, default = 'images', help='Augmentation level. 0 = soft  1 = medium 2 = full ')
        ...
        if success:
            ...
            if isdebugmode:
                ...
                if isgeneratevocformat:
                    save_xml_coordinates(imagesdirectory,'Train',filename,frame,box,label)
                ...
                if isgeneratevocformat:
                    save_xml_coordinates(imagesdirectory,'Train',filename,frameclone,box,label)
                if isgenerateyoloformat:
                    save_yolo_format(imagesdirectory,filename,(xmin, ymin), (xmax, ymax), W, H)
